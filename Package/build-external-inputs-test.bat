...
rem This script performs a test of the program build-external-inputs.py
...
rem Execute the program build-external-inputs.py

%PYTHON% %PYTHON_OPTIONS% build-external-inputs.py ^
