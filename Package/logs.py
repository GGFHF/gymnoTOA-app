...
'''
This file contains the classes related to the logs of gymnoTOA
...
class FormBrowseResultLogs(QWidget):
    ...
    def combobox_process_type_populate(self):
        ...
        process_type_list = ['', genlib.get_result_database_subdir(), genlib.get_result_installation_subdir(), genlib.get_result_run_subdir()]
    ...
    def combobox_process_populate(self):
        ...
        if self.combobox_process_type.currentText() == genlib.get_result_database_subdir():
            process_list = ['all'] + genlib.get_process_name_list(genlib.get_result_database_subdir())
        ...
        elif self.combobox_process_type.currentText() == genlib.get_result_run_subdir():
            process_list = ['all'] + genlib.get_process_name_list(genlib.get_result_run_subdir())
        else:
            process_list = ['']
...
if __name__ == '__main__':
    print(f'This file contains the classes related to logs used in {genlib.get_app_long_name()}')
    sys.exit(0)
